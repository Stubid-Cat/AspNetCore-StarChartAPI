...
namespace StarChart.Controllers
{
    ...
    public class CelestialObjectController : ControllerBase
    {
        ...
        [HttpPut("{id}")]
        public IActionResult Update (int id, CelestialObject celestialObjectUpdated)
        {
            var celestialObject = _context.CelestialObjects.Find(id);
            if (celestialObject == null)
            {
            ...
            celestialObject.Name = celestialObjectUpdated.Name;
            celestialObject.OrbitalPeriod = celestialObjectUpdated.OrbitalPeriod;
            celestialObject.OrbitedObjectId = celestialObjectUpdated.OrbitedObjectId;
